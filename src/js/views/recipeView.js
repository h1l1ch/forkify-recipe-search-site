...
const convertCount = (count) => {
    ...
    if (newCount) {
        // Convert number into string and store into two different variables. Separate integer part from decimal. Convert each element back into number.
...
const createIng = ing => `
    <li class="recipe__item">
        ...
        <div class="recipe__count">${(ing.count).toFixed(2)}</div>
